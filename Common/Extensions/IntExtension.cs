...
namespace Common.Extensions
{
    public static class IntExtension
    {
        ...
        public static string BuildResourceId(this int id)
        {
            return "SID" + id.ToString("D6");
        }

        /// <summary>
        /// Validates the value as being within the specified range. 
        /// </summary>
        /// <param name="value">The value to validate.</param>
        /// <param name="minValue">The lower end of the range.</param>
        /// <param name="maxValue">The upper end of the range.</param>
        /// <returns>Returns true if within range.</returns>
        public static bool ValidateAsWithinRange(this int value, int minValue, int maxValue)
        {
