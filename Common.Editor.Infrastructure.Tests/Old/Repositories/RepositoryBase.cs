using System;
using Common.Editor.Infrastructure.Connections.Fakes;
using Common.Editor.Infrastructure.DataSources.Fakes;
using Common.Editor.Infrastructure.Repositories.Fakes;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace Common.Editor.Infrastructure.Tests.Old.Repositories
{
    [TestClass]
